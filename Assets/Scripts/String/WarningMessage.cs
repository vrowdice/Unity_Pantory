/// <summary>
/// 경고 팝업 메시지 로컬라이즈 키 정의.
/// WarningMessage 테이블과 함께 사용합니다.
/// </summary>
public static class WarningMessage
{
    public const string ResearchCannotUnlock = "ResearchCannotUnlock";
    public const string PleaseEnterCategoryName = "PleaseEnterCategoryName";
    public const string FailedToCreateCategory = "FailedToCreateCategory";
